    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='workers', to='tasks.position')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='tasks', to='tasks.tasktype')),
            ],
            options={
                'ordering': ['deadline'],
            },
